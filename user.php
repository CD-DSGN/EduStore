...
'register_teacher', 'phoneAndMessageCode','sendPhoneAndIdentifyCode','get_course','get_province', 'get_city','get_town','check_mobile_phone', 'check_identifyCode', 'check_invite_code', 'get_school', 'get_grade','check_teacher_grade_class');
...
/* 登录状态修改会员密码 */
elseif ($action == 'act_edit_password_already_login')
{
    include_once(ROOT_PATH . 'includes/lib_passport.php');
